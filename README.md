...
Notice now, that a counter variable is automatically maintained and passed in with the vals parameter along with your custom values. Make note of this as you wouldn't want to conflict with this value by using the 'count' value yourself. In fact, there is also a vals.chain value automatically set, which is a reference to the chain object itself.
